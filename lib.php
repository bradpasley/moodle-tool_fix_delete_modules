 ...
 */
function get_adhoctasks_table(bool $htmloutput = false, stdClass $customdatacms = null, int $climinfaildelay = 0) {
    global $DB;
...
function get_all_cmdelete_adhoctasks_data(int $climinfaildelay = 0) {
    global $DB;
